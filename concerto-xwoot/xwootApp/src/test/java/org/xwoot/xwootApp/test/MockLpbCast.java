...
public class MockLpbCast implements LpbCastAPI, Serializable {
    ...
    private int round;
    private transient List<XWoot> receivers;
     ...
     *             DOCUMENT ME!
     */
    public MockLpbCast(String workingDirPath, int messagesRound, int logDelay,
        ...
        this.receivers = new ArrayList<XWoot>();
     ...
     *            DOCUMENT ME!
     */
    public void notifyNeighbor(XWoot receiver, Object toSend) {
        if (receiver==null) {
            return;
        }
        try {
    ...
    public void sendTo(Object to, Object toSend) throws IOException {
        if (to instanceof String){
            ...
            this.notifyNeighbor((XWoot) to, toSend);
        }
    }

    private XWoot getReceiver(String originalPeerId) throws Exception {
        XWoot result=null;
